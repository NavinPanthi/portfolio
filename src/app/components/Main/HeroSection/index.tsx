...
const HeroSection = () => {
  return (
    <section className="min-h-[calc(100vh-80px)] mt-20  flex items-center flex-col md:flex-row justify-center  md:justify-around 2xl:px-16 gap-16 md:gap-0 modal inset-0 ">
      {/* <section className="min-h-[calc(100vh-80px)] mt-20  flex items-center flex-col sm:flex-row  justify-center gap-16 md:gap-24 xl:gap-64 xl:px-16"> */}
      ...
      <div className="flex flex-col gap-10 w-96 items-center ">
        ...
        <div className="flex gap-3 w-full mx-5 justify-center">
          <button className="secondary-btn lg:secondary-btn-md">
            Download CV
          </button>
          <button className="primary-btn lg:primary-btn-md">
            Contact Info
          </button>
        </div>
